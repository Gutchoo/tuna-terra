...
type FinancialAction = 
  ...
  | { type: 'SET_ACTIVE_CALCULATOR'; payload: string | null }
...
function financialReducer(state: FinancialState, action: FinancialAction): FinancialState {
  switch (action.type) {
    case 'SET_ACTIVE_SECTION': {
      ...
      return { ...state, activeSection: action.payload, activeCalculator: null, viewedSections: newViewedSections }
    }
    case 'SET_ACTIVE_CALCULATOR': {
      return { ...state, activeCalculator: action.payload, activeSection: action.payload ? 'calculators' : state.activeSection }
    }
