...
import { CalculatorsContent } from "@/components/financial-modeling/calculators/CalculatorsContent"
...
export default function FinancialModelingPage() {
  ...
  const renderContent = () => {
    ...
    // Otherwise render regular sections
  ...
  // Determine if we should show the Deal Summary Panel
  const showDealSummary = state.activeSection !== 'calculators'
          ...
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              ...
              <div className="flex flex-1 w-full">
                ...
                {/* Deal Summary Panel - Only show when not in calculator mode */}
                {showDealSummary && (
