...
// Get a single income transaction with documents
// ============================================================================
export async function GET(
  ...
  try {
    ...
    const transaction = await DatabaseService.getIncomeTransaction(transactionId)
    ...
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Failed to fetch income transaction' },
      { status: 500 }
    )
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    const transaction = await DatabaseService.updateIncomeTransaction(transactionId, {
    ...
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Failed to update income transaction' },
      { status: 500 }
    )
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    await DatabaseService.deleteIncomeTransaction(transactionId, delete_recurring)
    ...
    return NextResponse.json(
      { error: error instanceof Error ? error.message : 'Failed to delete income transaction' },
      { status: 500 }
    )
  }
}
