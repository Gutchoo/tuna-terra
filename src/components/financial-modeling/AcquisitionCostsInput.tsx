...
interface AcquisitionCostsInputProps {
  label: string
  value: number
...
export function AcquisitionCostsInput({
  label,
  value,
  type,
  onValueChange,
  ...
  // Calculate display value based on current type and purchase price
  ...
  return (
    <div className={cn('space-y-2', className)}>
      <div className="flex items-center gap-2">
        <Label htmlFor="acquisition-costs" className="text-sm font-medium">
          {label}
        </Label>
        <TooltipProvider>
          <Tooltip>
      ...
      <div className="flex">
        <Select value={type || 'percentage'} onValueChange={handleTypeChange}>
          ...
          <SelectContent>
            <SelectItem value="percentage">% of Purchase Price</SelectItem>
