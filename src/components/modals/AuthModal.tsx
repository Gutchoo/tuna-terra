...
import { LogInIcon, UserPlusIcon, CheckCircleIcon } from 'lucide-react'
      ...
      <DialogContent className="max-w-md sm:max-w-lg top-[45%]">
        ...
        <Tabs value={mode} onValueChange={(value) => setMode(value as AuthMode)} className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="sign-in" className="flex items-center gap-2">
              <LogInIcon className="h-4 w-4" />
              Sign In
            </TabsTrigger>
            <TabsTrigger value="sign-up" className="flex items-center gap-2">
